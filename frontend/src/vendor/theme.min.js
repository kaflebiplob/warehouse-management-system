...
var demoMode = (function () {
  var e,
    ...
    S = {
      colorScheme: localStorage.getItem("magnaColorScheme")
        ? localStorage.getItem("magnaColorScheme")
        : "light",
      navPosition: localStorage.getItem("magnaNavPosition")
        ? localStorage.getItem("magnaNavPosition")
        : "sidenav",
      navColor: localStorage.getItem("magnaNavColor")
        ? localStorage.getItem("magnaNavColor")
        : "default",
      sidebarSize: localStorage.getItem("magnaSidebarSize")
        ? localStorage.getItem("magnaSidebarSize")
        : "base",
    };
  function C(e) {
  ...
  return (
      ...
      for (
        ...
        ("colorScheme" != o &&
          ...
          (localStorage.setItem(
            "magna" + o.charAt(0).toUpperCase() + o.slice(1),
            l,
          ),
          (S[o] = l));
      }
    })(),
    "light" == (e = S.colorScheme)
      ? ((g.disabled = !1), (y.disabled = !0), (e = "light"))
      : "dark" == e && ((g.disabled = !0), (y.disabled = !1), (e = "dark")),
    (function (e) {
      if (i && d && u && f && p && b)
        if ("topnav" == e) {
          (k(d), k(u), k(f));
          for (var t = 0; t < m.length; t++)
            (m[t].classList.remove("container-fluid"),
              m[t].classList.add("container"));
        } else if ("combo" == e) {
          (k(i), k(p), k(b));
          for (t = 0; t < m.length; t++)
            (m[t].classList.remove("container"),
              m[t].classList.add("container-fluid"));
        } else if ("sidenav" == e) {
          (k(i), k(d));
          for (t = 0; t < m.length; t++)
            (m[t].classList.remove("container"),
    ...
    $(o)
      ...
      .button("toggle"),
    $(o)
      .find('[name="navPosition"][value="' + n + '"]')
      .closest(".btn")
      .button("toggle"),
    $(o)
      .find('[name="navColor"][value="' + r + '"]')
      .closest(".btn")
      .button("toggle"),
    $(o)
      ...
      (c.addEventListener("submit", function (e) {
        (e.preventDefault(),
          (function (e) {
            ...
            (localStorage.setItem("magnaColorScheme", t),
              localStorage.setItem("magnaNavPosition", a),
              localStorage.setItem("magnaNavColor", o),
              localStorage.setItem("magnaSidebarSize", l),
...
(!(function () {
    ...
    (!(function e(t, a) {
      ...
      (l || n) &&
        (function (e, n, r) {
          ((n = n || ""),
            (r = r || ""),
            (e.options.scales.yAxes[0].ticks.callback = function (e) {
              ...
              return (
                1 < t.datasets.length &&
                  (l +=
                    ...
                    "</span>"),
                (l +=
                  '<span class="popover-body-value">' + n + o + r + "</span>")
              );
            }));
        })(a, l, n),
      a.update());
  ...
  "undefined" != typeof Chart &&
    ...
    (Chart.defaults.global.tooltips.custom = function (l) {
          ...
          ((r += '<div class="arrow"></div>'),
            ...
            n.forEach(function (e, t) {
              var a =
                  ...
                  l.labelColors[t].backgroundColor +
                  '"></span>',
                o =
                  1 < n.length
    ...
    (Chart.defaults.global.tooltips.callbacks.label = function (e, t) {
      ...
      return (
        1 < t.datasets.length &&
          (l += '<span class="popover-body-label mr-auto">' + a + "</span>"),
        (l += '<span class="popover-body-value">' + o + "</span>")
      );
    }),
  ...
  (function () {
    var e = {
      ...
      t = localStorage.getItem("magnaColorScheme")
        ? localStorage.getItem("magnaColorScheme")
        : "light";
    function a() {
                ...
                return (
                  1 < t.datasets.length &&
                    (l +=
                      ...
                      a +
                      "</span>"),
                  (l += '<span class="popover-body-value">$' + o + "k</span>")
                );
              },
            },
          },
                ...
                return (
                  1 < t.datasets.length &&
                    (l +=
                      ...
                      a +
                      "</span>"),
                  (l += '<span class="popover-body-value">' + o + "hrs</span>")
                );
              },
            },
          },
      ...
      [].forEach.call(e, function (e) {
        !(function (e) {
          ...
          var a = {
            ...
            o = Object.assign(t, a);
          ((mapboxgl.accessToken = ""), new mapboxgl.Map(o));
        })(e);
      });
  })(),
  (function () {
    ...
    $(e).on("show.bs.collapse", function () {
      !(function (t) {
        var e = t
          .closest(".navbar-nav, .navbar-nav .nav")
    ...
    jQuery().select2 &&
      ...
      [].forEach.call(e, function (e) {
        !(function (e) {
          ...
          t = t ? JSON.parse(t) : {};
          var a = {
              dropdownParent: $(e).closest(".modal").length
                ? $(e).closest(".modal")
                : $(document.body),
              templateResult: l,
            },
